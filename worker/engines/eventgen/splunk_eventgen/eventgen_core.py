        ...
        for filename in os.listdir(dirname):
            ...
            if os.path.isfile(filename):
                ...
                if extension == ".py" and (
                    ...
                    try:
                        # Import the module. imp was removed in py3.12; importlib is
                        # the supported equivalent. Register under the bare basename in
                        # sys.modules like imp.load_module did, so multiprocess pickling
                        # of plugin instances keeps working.
